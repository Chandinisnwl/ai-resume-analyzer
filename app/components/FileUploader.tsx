        ...
        <div className="space-y-4 cursor-pointer">
          {file ? (
            <div className="uploader-selected-file" onClick={(e) => e.stopPropagation()}>
              <img src="public/fonts/images/pdf.png" alt="pdf" className="size-10" />
              ...
              <button className="p-2 cursor-pointer" onClick={(e) => onFileSelect?.(null)}>
                <img src="public/fonts/icons/cross.svg" alt="remove" className="w-4 h-4" />
              </button>
            </div>
          ) : (
            <div>
              <div className="mx-auto w-16  flex items-center justify-center mb-2">
                <img
                  src="public/fonts/icons/info.svg"
                  alt="upload"
                  className="size-20"
                />
              </div>
